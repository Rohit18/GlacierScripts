...
directory = os.getcwd() + '\\S14B_applyNoiseMasks\\'
...
for path in pathlist:
    ...
    mainImage = os.getcwd() + '\\S14B_applyNoiseMasks\\' + filename + '.png'
    ...
    applyMask.save(os.getcwd() + '\\S15_afterSumThreshold\\' + filename + '.png')