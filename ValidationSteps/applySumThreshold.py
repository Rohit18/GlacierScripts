...
directory = os.getcwd() + '\\S12_removeZones\\'
...
for path in pathlist:
    ...
    mainImage = os.getcwd() + '\\S12_removeZones\\' + filename + '.png'
    ...
    applyMask.save(os.getcwd() + '\\S14_afterSumThreshold\\' + filename + '.png')